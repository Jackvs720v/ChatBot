...
from llama_index.embedding.huggingface import HuggingFaceEmbedding # biblioteca para fazer o embedding
from llama_index.vector_stores.chroma import ChromaVectorStorage # biblioteca para o banco de dados
